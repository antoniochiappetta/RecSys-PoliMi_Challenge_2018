...
class ItemCFKNNRecommender(object):
    ...
    def fit(self, topK=50, shrink=100, normalize=True, similarity="cosine"):
        similarity_object_track = Compute_Similarity_Python(self.URM_all.T, shrink=shrink, topK=topK,
    ...
    def recommend(self, playlist_id, at=10, exclude_duplicates=True):
        ...
        playlist_profile = self.W_sparse[playlist_id]
        scores = playlist_profile.dot(self.URM).toarray().ravel()
